package io.quarkiverse.temporal.graal.grpchandling.runtime.graal;
...
final class Target_io_grpc_netty_ProtocolNegotiators {
    ...
    static void logSslEngineDetails(Level level, ChannelHandlerContext ctx, String msg, Throwable t) {
        Logger log = Logger.getLogger("io.grpc.netty.shaded.io.grpc.netty.ProtocolNegotiators");
...
@TargetClass(className = "io.grpc.netty.shaded.io.grpc.netty.Utils")
