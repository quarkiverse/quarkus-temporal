...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.codec.compression.ZstdEncoder", onlyWith = IsZstdAbsent.class)
...
@Substitute
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.codec.compression.ZstdConstants", onlyWith = IsZstdAbsent.class)
