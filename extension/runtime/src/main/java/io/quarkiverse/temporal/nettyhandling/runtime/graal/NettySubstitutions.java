package io.quarkiverse.temporal.nettyhandling.runtime.graal;

import static io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeaderValues.BR;
import static io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeaderValues.DEFLATE;
import static io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeaderValues.GZIP;
import static io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeaderValues.X_DEFLATE;
import static io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeaderValues.X_GZIP;
...
import io.grpc.netty.shaded.io.netty.handler.ssl.SslContextOption;
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.SslProvider")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator")
...
/**
 * Hardcode io.grpc.netty.shaded.io.netty.handler.ssl.OpenSsl as non-available
 */
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.OpenSsl")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator$AlpnWrapper")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkAlpnSslEngine")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.util.concurrent.AbstractScheduledEventExecutor")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.buffer.EmptyByteBuf")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.codec.http.HttpContentDecompressor")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.codec.http2.DelegatingDecompressorFrameListener")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.SslHandler")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.PemReader")
 ...
 */
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.SslContext", onlyWith = IsBouncyNotThere.class)
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.util.internal.shaded.org.jctools.util.UnsafeLongArrayAccess")
