...
It is possible to associate the workflow with one or more named workers instead by annotating it with @WorkflowImpl:
...
It is possible to associate the activity with one or more named workers instead by annotating it with @ActivityImpl:
