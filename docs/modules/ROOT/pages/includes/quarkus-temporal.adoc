...
a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-context-propagator-classes]]`link:#quarkus-temporal_quarkus-temporal-context-propagator-classes[quarkus.temporal.context-propagator-classes]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_CONTEXT_PROPAGATOR_CLASSES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_CONTEXT_PROPAGATOR_CLASSES+++`
endif::add-copy-button-to-env-var[]
--|list of string 
|
...
a| [[quarkus-temporal_quarkus-temporal-enable-telemetry]]`link:#quarkus-temporal_quarkus-temporal-enable-telemetry[quarkus.temporal.enable-telemetry]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_ENABLE_TELEMETRY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_ENABLE_TELEMETRY+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`false`
