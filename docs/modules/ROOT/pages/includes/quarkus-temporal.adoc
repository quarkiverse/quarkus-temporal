...
a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-enabled]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-enabled[`+++quarkus.temporal.devservices.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-image-name]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-image-name[`+++quarkus.temporal.devservices.image-name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.image-name+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_IMAGE_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_IMAGE_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++temporalio/temporal:1.8.2+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-port]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-port[`+++quarkus.temporal.devservices.port+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.port+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_PORT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_PORT+++`
endif::add-copy-button-to-env-var[]
--
|int
|

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-service-name]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-service-name[`+++quarkus.temporal.devservices.service-name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.service-name+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_SERVICE_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_SERVICE_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++temporal+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-shared]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-shared[`+++quarkus.temporal.devservices.shared+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.shared+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_SHARED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_SHARED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-reuse]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-reuse[`+++quarkus.temporal.devservices.reuse+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.reuse+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether a shared dev-mode container should be reusable after the application that started it exits. Requires Testcontainers reuse to be enabled in `~/.testcontainers.properties`.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_REUSE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_REUSE+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-show-logs]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-show-logs[`+++quarkus.temporal.devservices.show-logs+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.show-logs+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_SHOW_LOGS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_SHOW_LOGS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-namespaces]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-namespaces[`+++quarkus.temporal.devservices.namespaces+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.namespaces+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_NAMESPACES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_NAMESPACES+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|

a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-devservices-web-ui-url]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-devservices-web-ui-url[`+++quarkus.temporal.devservices.web-ui-url+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.devservices.web-ui-url+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_DEVSERVICES_WEB_UI_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_DEVSERVICES_WEB_UI_URL+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
[.description]
--
Specifies server behavior if a completed workflow with the same id exists. Note that under no conditions Temporal allows two workflows with the same namespace and workflow id run simultaneously. See `workflow-id-conflict-policy` for handling a workflow id duplication with a Running workflow.

 - `ALLOW_DUPLICATE` allows a new run regardless of the previous run's final status. The previous run still must be closed or the new run will be rejected.
 - `ALLOW_DUPLICATE_FAILED_ONLY` allows a new run if the previous run failed, was canceled, or terminated.
 - `REJECT_DUPLICATE` never allows a new run, regardless of the previous run's final status.
 - `TERMINATE_IF_RUNNING` is the same as `ALLOW_DUPLICATE`, but if there exists a not-closed run in progress, it will be terminated. It cannot be combined with an explicit `workflow-id-conflict-policy`.
...
[.description]
--
Specifies server behavior if a Running workflow with the same id exists. See `workflow-id-reuse-policy` for handling a workflow id duplication with a Closed workflow.

 - `FAIL` does not start a new workflow, the start fails with WorkflowExecutionAlreadyStarted instead.
 - `USE_EXISTING` does not start a new workflow, the handle of the running workflow is returned instead.
 - `TERMINATE_EXISTING` terminates the running workflow before starting a new one.

Cannot be set when `workflow-id-reuse-policy` is `TERMINATE_IF_RUNNING`, and `TERMINATE_EXISTING` cannot be combined with `workflow-id-reuse-policy=REJECT_DUPLICATE`. When left unset (`UNSPECIFIED`) the policy is not sent to the server, which then applies its own default of `FAIL`. Default value if not set: UNSPECIFIED
...
a|icon:lock[title=Fixed at build time] [[quarkus-temporal_quarkus-temporal-worker-build-id]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-build-id[[.line-through]#`+++quarkus.temporal.worker.build-id+++`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.build-id+++[]
endif::add-copy-button-to-config-props[]


[.line-through]#`+++quarkus.temporal.worker."worker-name".build-id+++`#
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated: Use `quarkus.temporal.worker.deployment-options.build-id` of link:https://docs.temporal.io/worker-deployments[Worker Deployment API] to configure the buildId. If `quarkus.temporal.worker.deployment-options` is configured, this property is ignored._
...
a| [[quarkus-temporal_quarkus-temporal-worker-use-build-id-for-versioning]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-use-build-id-for-versioning[[.line-through]#`+++quarkus.temporal.worker.use-build-id-for-versioning+++`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.use-build-id-for-versioning+++[]
endif::add-copy-button-to-config-props[]


[.line-through]#`+++quarkus.temporal.worker."worker-name".use-build-id-for-versioning+++`#
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated: Use `quarkus.temporal.worker.deployment-options.use-versioning` to activate link:https://docs.temporal.io/worker-deployments[Worker Deployment API]. If `quarkus.temporal.worker.deployment-options` is configured, this property is ignored._
...
h|[[quarkus-temporal_section_quarkus-temporal-worker-deployment-options]] [.section-name.section-level0]##link:#quarkus-temporal_section_quarkus-temporal-worker-deployment-options[Configuration of Worker Deployment Versioning]##
h|Type
h|Default

a| [[quarkus-temporal_quarkus-temporal-worker-deployment-options-name]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-deployment-options-name[`+++quarkus.temporal.worker.deployment-options.name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.deployment-options.name+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.temporal.worker."worker-name".deployment-options.name+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker."worker-name".deployment-options.name+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The deployment name, which groups related workers across versions. If set, `buildId` MUST be defined.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-temporal_quarkus-temporal-worker-deployment-options-build-id]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-deployment-options-build-id[`+++quarkus.temporal.worker.deployment-options.build-id+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.deployment-options.build-id+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.temporal.worker."worker-name".deployment-options.build-id+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker."worker-name".deployment-options.build-id+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The Build ID identifying a specific release of your worker code within a deployment. If set, `name` MUST be defined.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_BUILD_ID+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_BUILD_ID+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-temporal_quarkus-temporal-worker-deployment-options-version]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-deployment-options-version[`+++quarkus.temporal.worker.deployment-options.version+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.deployment-options.version+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.temporal.worker."worker-name".deployment-options.version+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker."worker-name".deployment-options.version+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
The deployment version, combining a deployment name and a Build ID (format: `<name>.<buildId>`). If `buildId` and `name` are defined, this property will be ignored.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_VERSION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_VERSION+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-temporal_quarkus-temporal-worker-deployment-options-use-versioning]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-deployment-options-use-versioning[`+++quarkus.temporal.worker.deployment-options.use-versioning+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.deployment-options.use-versioning+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.temporal.worker."worker-name".deployment-options.use-versioning+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker."worker-name".deployment-options.use-versioning+++[]
endif::add-copy-button-to-config-props[]

[.description]
--
If true, opts this worker into the Worker Deployment Versioning feature. Requires `version` to be set.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_USE_VERSIONING+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_USE_VERSIONING+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

a| [[quarkus-temporal_quarkus-temporal-worker-deployment-options-default-versioning-behavior]] [.property-path]##link:#quarkus-temporal_quarkus-temporal-worker-deployment-options-default-versioning-behavior[`+++quarkus.temporal.worker.deployment-options.default-versioning-behavior+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker.deployment-options.default-versioning-behavior+++[]
endif::add-copy-button-to-config-props[]


`+++quarkus.temporal.worker."worker-name".deployment-options.default-versioning-behavior+++`
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.temporal.worker."worker-name".deployment-options.default-versioning-behavior+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_DEFAULT_VERSIONING_BEHAVIOR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_DEPLOYMENT_OPTIONS_DEFAULT_VERSIONING_BEHAVIOR+++`
endif::add-copy-button-to-env-var[]
--
a|`unspecified`, `pinned`, `auto-upgrade`
|
...
h|[[quarkus-temporal_section_quarkus-temporal-worker-factory]] [.section-name.section-level0]##link:#quarkus-temporal_section_quarkus-temporal-worker-factory[Configuration for the worker factory that drives how workflows and activities are executed]##
h|Type
h|Default
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_USING_VIRTUAL_WORKFLOW_THREADS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_USING_VIRTUAL_WORKFLOW_THREADS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_MAX_WORKFLOW_THREAD_COUNT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_MAX_WORKFLOW_THREAD_COUNT+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++600+++`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_WORKFLOW_CACHE_SIZE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_WORKFLOW_CACHE_SIZE+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++600+++`
...
[.description]
--
Controls whether application startup fails when Temporal workers cannot start (for example, when the Temporal server is unreachable). Set to false to let the application continue booting without started workers.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_FAIL_ON_STARTUP_ERROR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_FAIL_ON_STARTUP_ERROR+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
[.description]
--
Maximum number of attempts to start workers during application startup. This is useful when Temporal is temporarily unavailable at boot time. Ignored when startupBackgroundRetryEnabled is true.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_MAX_ATTEMPTS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_MAX_ATTEMPTS+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++1+++`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_RETRY_DELAY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_RETRY_DELAY+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-temporal_quarkus-temporal[icon:question-circle[title=More information about the Duration format]]
|`+++2S+++`
...
[.description]
--
When enabled (and failOnStartupError is false), worker startup retries run in the background and do not block application startup.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_BACKGROUND_RETRY_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_TEMPORAL_WORKER_FACTORY_STARTUP_BACKGROUND_RETRY_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
